...
# 3) Set the variable ROKU_DEV_PASSWORD in your environment with the developer
#    password that you have set for your Roku box, e.g.
#      export ROKU_DEV_PASSWORD=mypassword
...
# their ROKU_DEV_PASSWORD environment variable.
# -------------------------------------------------------------------------
define CHECK_ROKU_DEV_PASSWORD
	if [ -z "$(ROKU_DEV_PASSWORD)" ]; then \
		$(ECHO) "Note: ROKU_DEV_PASSWORD is not set."; \
	fi
endef
